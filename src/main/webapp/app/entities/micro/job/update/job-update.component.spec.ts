...
import { TaskService } from 'app/entities/micro/task/service/task.service';
...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 18658 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 10850 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 31445 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 2434 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 2437 };
      job.tasks = [task];
      const employee: IEmployee = { id: 687 };
      job.employee = employee;
