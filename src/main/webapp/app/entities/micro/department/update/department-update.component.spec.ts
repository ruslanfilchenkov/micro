...
import { LocationService } from 'app/entities/micro/location/service/location.service';
...
describe('Department Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call location query and add missing value', () => {
      ...
      const location: ILocation = { id: 10916 };
      department.location = location;

      const locationCollection: ILocation[] = [{ id: 28871 }];
    ...
    it('Should update editForm', () => {
      const department: IDepartment = { id: 456 };
      const location: ILocation = { id: 5379 };
      department.location = location;
