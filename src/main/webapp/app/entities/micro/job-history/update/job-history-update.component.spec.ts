...
import { JobService } from 'app/entities/micro/job/service/job.service';
import { IDepartment } from 'app/entities/micro/department/department.model';
import { DepartmentService } from 'app/entities/micro/department/service/department.service';
import { IEmployee } from 'app/entities/micro/employee/employee.model';
import { EmployeeService } from 'app/entities/micro/employee/service/employee.service';
...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 28396 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 9718 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 10167 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 249 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 23183 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 6230 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 28913 };
      jobHistory.job = job;
      const department: IDepartment = { id: 24233 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 24236 };
      jobHistory.employee = employee;
