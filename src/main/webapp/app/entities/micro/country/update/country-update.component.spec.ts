...
import { RegionService } from 'app/entities/micro/region/service/region.service';
...
describe('Country Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call region query and add missing value', () => {
      ...
      const region: IRegion = { id: 3 };
      country.region = region;

      const regionCollection: IRegion[] = [{ id: 22331 }];
