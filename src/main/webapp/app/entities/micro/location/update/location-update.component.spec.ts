...
import { CountryService } from 'app/entities/micro/country/service/country.service';
...
describe('Location Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call country query and add missing value', () => {
      ...
      const country: ICountry = { id: 25662 };
      location.country = country;

      const countryCollection: ICountry[] = [{ id: 6590 }];
    ...
    it('Should update editForm', () => {
      const location: ILocation = { id: 456 };
      const country: ICountry = { id: 10874 };
      location.country = country;
